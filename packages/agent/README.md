...
The agent loop (perceive → reason → act → report), persona loading, the model gateway, the
MCP/tool client, and the sandbox runner client. Owns agent-specific behavior rather than being
...
- [`docs/epics/10-code-sandbox.md`](../../docs/epics/10-code-sandbox.md)
